<template>
    <div><!--订单管理-->
        ...
        <el-table border style="width: 100%" :data="tableData" max-height="470px" min-height="470px"
            ...
            <el-table-column :formatter="getSumPrice"  label="总价" width="90"></el-table-column>
            <el-table-column prop="cost_price" label="成本" width="90"></el-table-column>
            <el-table-column prop="other_cost" label="其他成本" width="90"></el-table-column>
            <el-table-column :formatter="getSumCost" label="总成本" width="90"></el-table-column>
