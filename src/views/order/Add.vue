  ...
  <el-dialog title="添加订单" :visible.sync="showDialog" width="50%" @close="handleClose" @open="handleOpen">
    ...
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="cas号">
        <el-input v-model="cas" placeholder="请输入cas号" />
      </el-form-item>
      <el-form-item label="商品名称">
        <el-input v-model="commodityName" placeholder="请输入商品名称" />
      </el-form-item>
      <el-form-item>
    ...
    <el-form ref="formRef" :model="form">
      ...
      <el-form-item label="库存编号" :label-width="formLabelWidth" prop="gender">
        ...
        <Inventory ref="addRef" :inventory-visible="inventoryVisible" :value="infoId" @changeShow="showInventory" />
      </el-form-item>
      <el-form-item label="客户名称" :label-width="formLabelWidth" prop="gender">
        <el-input v-model="form.user_name" placeholder="请输入客户名称" />
      </el-form-item>
